...
na [stronie](https://solarianprogrammer.com/2019/05/09/cpp-17-stl-parallel-algorithms-gcc-intel-tbb-linux-macos).
...
```{important}
Funkcje lub obiekty funkcyjne przekazane do algorytmu współbieżnego nie powinny
...
* `FwdIt2 exclusive_scan( ExecutionPolicy&& policy, FwdIt1 first, FwdIt1 last, FwdIt2 d_first, T init)`
  ...
  Przedrostek *exclusive* oznacza, że i-ty element nie jest uwzględniany w i-tej sumie.
